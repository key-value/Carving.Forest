// Carving.Domain.Core Repository.cs
// writer sundy
// Last Update Time 2015-04-14-20:30
// Create Time 2015-04-14-20:30
...
namespace Carving.Domain.Core.Repositories
{
    ...
    ///     The type of the aggregate root on which the repository operations
    ///     should be performed.
    /// </typeparam>
        ...
        where TAggregateRoot : class, IAggregateRoot
    {
        ...
        /// </returns>
        public IEnumerable<TAggregateRoot> GetAll(Expression<Func<TAggregateRoot, dynamic>> sortPredicate,
            SortOrder sortOrder)
        {
        ...
        /// <returns>
        ///     All the aggregate roots got from the repository for the specified page, with the aggregate roots being sorted by
        ///     using the provided sort predicate and the sort order.
        /// </returns>
        ...
        ///     using the provided sort predicate and the sort order.
        /// </returns>
        public IEnumerable<TAggregateRoot> FindAll(Expression<Func<TAggregateRoot, dynamic>> sortPredicate,
            SortOrder sortOrder)
        {
        ...
        ///     using the provided sort predicate and the sort order.
        /// </returns>
        public PagedResult<TAggregateRoot> FindAll(Expression<Func<TAggregateRoot, dynamic>> sortPredicate,
            SortOrder sortOrder, int pageNumber, int pageSize)
        {
        ...
        public IEnumerable<TAggregateRoot> GetAll(Expression<Func<TAggregateRoot, dynamic>> sortPredicate,
            SortOrder sortOrder, params Expression<Func<TAggregateRoot, dynamic>>[] eagerLoadingProperties)
        {
        ...
        ///     using the provided sort predicate and the sort order.
        /// </returns>
        protected virtual IEnumerable<TAggregateRoot> DoGetAll(Expression<Func<TAggregateRoot, dynamic>> sortPredicate,
            SortOrder sortOrder)
        {
        ...
        ///     using the provided sort predicate and the sort order.
        /// </returns>
        protected virtual PagedResult<TAggregateRoot> DoGetAll(Expression<Func<TAggregateRoot, dynamic>> sortPredicate,
            SortOrder sortOrder, int pageNumber, int pageSize)
        {
        ...
        ///     and the sort order.
        /// </returns>
        protected abstract PagedResult<TAggregateRoot> DoGetAll(ISpecification<TAggregateRoot> specification,
            Expression<Func<TAggregateRoot, dynamic>> sortPredicate, SortOrder sortOrder, int pageNumber, int pageSize);
        ...
        ///     using the provided sort predicate and the sort order.
        /// </returns>
        protected virtual IEnumerable<TAggregateRoot> DoFindAll(Expression<Func<TAggregateRoot, dynamic>> sortPredicate,
            SortOrder sortOrder)
        {
        ...
        ///     using the provided sort predicate and the sort order.
        /// </returns>
        protected virtual PagedResult<TAggregateRoot> DoFindAll(Expression<Func<TAggregateRoot, dynamic>> sortPredicate,
            SortOrder sortOrder, int pageNumber, int pageSize)
        {
        ...
        ///     and the sort order.
        /// </returns>
        protected abstract IEnumerable<TAggregateRoot> DoFindAll(ISpecification<TAggregateRoot> specification,
            Expression<Func<TAggregateRoot, dynamic>> sortPredicate, SortOrder sortOrder);
        ...
        ///     and the sort order.
        /// </returns>
        protected abstract PagedResult<TAggregateRoot> DoFindAll(ISpecification<TAggregateRoot> specification,
            Expression<Func<TAggregateRoot, dynamic>> sortPredicate, SortOrder sortOrder, int pageNumber, int pageSize);
